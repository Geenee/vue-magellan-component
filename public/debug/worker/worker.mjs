    ...
    */
    ...
    class Element extends ParentNode {
      constructor(nodeType, localName, namespaceURI, ownerDocument, overrideIndex) {
        ...
        /* index */
        ], this.nodeType, store(this.localName), 0, this.namespaceURI === null ? 0 : store(this.namespaceURI)];
      } // Unimplemented properties
    ...
    */
    ...
    class OffscreenCanvasRenderingContext2DPolyfill {
      ...
      /* mutated */
        ...
        /* OBJECT_MUTATION */
        , store(fnName), args.length, ...this[68
        /* serializeAsTransferrableObject */
      ...
      createObjectReference(objectId, creationMethod, creationArgs) {
        ...
        /* OBJECT_CREATION */
        , store(creationMethod), objectId, creationArgs.length, ...this[68
        /* serializeAsTransferrableObject */
    ...
    */
    ...
    class Document extends Element {
      constructor(global) {
        ...
        this[_a] = true; // Element uppercases its nodeName, but Document doesn't.
